...
public:
    ...
    typedef enum {
        ...
        k_mode_hdhold           = 13,           ///< enter hdhold mode
        k_mode_shinguided       = 14,           ///< enter shinguided mode
        k_mode_auto_dive        = 15,           ///< enter autodive mode
        k_mode_auto_dive_circle = 16,           ///< enter autodive mode
